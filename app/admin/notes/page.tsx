    ...
    <NotesLiveRefresh latestChangedAt={latestChangedAt}>
      <header>
        ...
        <h2 className="mt-2 text-3xl font-bold tracking-tight text-foreground">
          Operational notes overview
        </h2>
        <p className="mt-3 max-w-3xl leading-7 text-secondary">
          Review general reception reminders and customer-specific notes. The
          latest 100 active notes in each section are shown.
        </p>
      </header>
      ...
      <div className="mt-8 grid gap-8 xl:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        <GeneralNotesSection notes={generalNotes} returnPath="/admin/notes" />
        <div>
          <Card className="p-5">
            <div className="flex flex-wrap items-end justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-secondary">
                  Search by customer full name or member code.
                </p>
              </div>
              <Link
